 ...
 * @author 36194445
 */
public class CategoriaCriteriaPostgre implements EstablecimientosCriteriaPostgre{
    ...
    public List<EstablecimientoPost> filterCriteria(List<EstablecimientoPost> establecimientos, Integer[] IDs) {
        ...
        establecimientos.forEach((establecimiento) -> {
            CategoriaTipo categoria = establecimiento.getCategoria();
            if(categoria!=null&&list.contains(categoria.getId().intValue())){
